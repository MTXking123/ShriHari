...
const DetailCard = ({ service, onClose }) => {
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-60 flex justify-center pt-10 px-4 overflow-hidden">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl sm:max-w-4xl flex flex-col sm:flex-row relative p-4 sm:p-6">
        {/* Close button */}
        <button
          onClick={onClose}
