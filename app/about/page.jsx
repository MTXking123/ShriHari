  ...
  return (
    <section className="py-16 relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 mb-24 text-center">
        ...
        >
          We aim to revolutionize healthcare with accessible and personalized
          services, empowering every individual to lead a healthier and better
          life.
        </motion.p>
      </div>
      ...
      <div
        className="relative z-10 max-w-6xl mx-auto px-4 mb-24 flex flex-col lg:flex-row items-center gap-12 py-25"
        id="doctor-vivek"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-gray-700 text-base leading-relaxed mb-4">
            Dr. Vivek Sharma, the founder and CEO of Shrihari Eye Care & Laser
            Centre, is a visionary leader and expert eye specialist. With a
            mission to restore vision and improve lives, he has successfully
          ...
          <div className="bg-sky-50 p-4 rounded-lg shadow text-sm italic text-gray-700 mb-4">
            ...
            technology.” — <strong>Dr. Vivek Sharma</strong>
          </div>
        </motion.div>
      </div>
    </section>
